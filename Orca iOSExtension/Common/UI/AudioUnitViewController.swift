...
private let log = Logger(subsystem: "com.jeremydormitzer.Orca-iOSExtension", category: "AudioUnitViewController")

public class AudioUnitViewController: AUViewController, AUAudioUnitFactory {
    var audioUnit: AUAudioUnit?
    
    var hostingController: HostingController<Orca_iOSExtensionMainView>?
	...
	*/
    ...
    public func createAudioUnit(with componentDescription: AudioComponentDescription) throws -> AUAudioUnit {
        audioUnit = try Orca_iOSExtensionAudioUnit(componentDescription: componentDescription, options: [])
        
        guard let audioUnit = self.audioUnit as? Orca_iOSExtensionAudioUnit else {
            log.error("Unable to create Orca_iOSExtensionAudioUnit")
            return audioUnit!
        }
        ...
        audioUnit.setupParameterTree(Orca_iOSExtensionParameterSpecs.createAUParameterTree())
    ...
    private func configureSwiftUIView(audioUnit: AUAudioUnit) {
        ...
        let content = Orca_iOSExtensionMainView(parameterTree: observableParameterTree)
