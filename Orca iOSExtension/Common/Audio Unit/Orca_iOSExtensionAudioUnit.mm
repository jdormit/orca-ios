//
//  Orca_iOSExtensionAudioUnit.mm
//  Orca iOSExtension
//
//  Created by Jeremy Dormitzer on 4/10/23.
//

#import "Orca_iOSExtensionAudioUnit.h"

#import <AVFoundation/AVFoundation.h>
#import <CoreAudioKit/AUViewController.h>
#import <CoreMIDI/CoreMIDI.h>

#import "Orca_iOSExtensionAUProcessHelper.hpp"
#import "Orca_iOSExtensionDSPKernel.hpp"


// Define parameter addresses.

@interface Orca_iOSExtensionAudioUnit ()
...
@implementation Orca_iOSExtensionAudioUnit {
    // C++ members need to be ivars; they would be copied on access if they were properties.
    Orca_iOSExtensionDSPKernel _kernel;
...
- (void)setupParameterCallbacks {
    ...
    __block Orca_iOSExtensionDSPKernel *kernel = &_kernel;
